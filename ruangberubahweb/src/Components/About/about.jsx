...
const About = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center p-8 bg-black text-white h-screen space-y-8 md:space-y-0 md:space-x-8">
      {/* Left*/}
      <div className="flex flex-col max-w-lg md:mr-8 space-y-6">
        ...
        <button className="px-6 py-3 bg-[#7ed957] text-black font-semibold rounded">
          MARI BERUBAH!
        </button>
      </div>
      {/* Right */}
